...
document.getElementById(rgbValues[1]).style.backgroundColor="RGB("+ rFake + "," + rFake + "," + rFake +")"; //sets bg color for fake one
document.getElementById(rgbValues[2]).style.backgroundColor="RGB("+ rFake1 + "," + rFake1 + "," + rFake1 +")"; //sets bg color for fake one
